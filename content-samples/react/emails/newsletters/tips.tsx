...
const PropDefaults: NovuTipsEmailProps = {
  tips: [
    {
      id: 1,
      description:
  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={logo}>
          <Img width={86} src={`https://images.spr.so/cdn-cgi/imagedelivery/j42No7y-dcokJuNgXeA0ig/dca73b36-cf39-4e28-9bc7-8a0d0cd8ac70/standalone-gradient2x_2/w=128,quality=90,fit=scale-down`} />
        </Section>
          ...
          <Row>
            ...
            <Column style={headerImageContainer}>
              <Img
                style={headerImage}
                width={340}
                src={`https://react-email-demo-48zvx380u-resend.vercel.app/static/stack-overflow-header.png`}
              />
            </Column>
          </Row>
        </Section>
      ...
      <Section style={footer}>
        ...
        <Img width={31} src={`https://images.spr.so/cdn-cgi/imagedelivery/j42No7y-dcokJuNgXeA0ig/dca73b36-cf39-4e28-9bc7-8a0d0cd8ac70/standalone-gradient2x_2/w=128,quality=90,fit=scale-down`} />
        <Text style={footerAddress}>
          <strong>Novu</strong>, 110 William Street, 28th Floor, New
          York, NY 10038
        </Text>
...
NovuTipsEmail.PreviewProps = {
  tips: PropDefaults.tips,
} as NovuTipsEmailProps;

export default NovuTipsEmail;

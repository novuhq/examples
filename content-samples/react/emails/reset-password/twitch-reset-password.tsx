...
export const NovuResetPasswordEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>You updated the password for your Novu account</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={logo}>
            <Img width={114} src={`https://images.spr.so/cdn-cgi/imagedelivery/j42No7y-dcokJuNgXeA0ig/dca73b36-cf39-4e28-9bc7-8a0d0cd8ac70/standalone-gradient2x_2/w=128,quality=90,fit=scale-down`} />
          </Section>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              You updated the password for your Novu account on{" "}
            ...
            <Text style={paragraph}>
              ...
              Novu account. To learn more about how to create a strong and
              unique password,{" "}
              <Link href="#" style={link}>
                click here.
              </Link>
        ...
        <Section style={footer}>
          ...
          <Row>
            <Text style={{ textAlign: "center", color: "#706a7b" }}>
              © 2022 Novu, All Rights Reserved <br />

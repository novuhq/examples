      ...
      <Container style={container}>
        ...
        <Section>
          <Text style={cupomText}>
            Save 3% on all your Novu purchases with Novu Card.
            <sup style={supStyle}>1</sup>{" "}
            <Link href="https://www.novu.co/novu-card">
              ...
              <Section>
                <Row>
                  <Column style={informationTableColumn}>
                    <Text style={informationTableLabel}>Novu ID</Text>
                    <Link
                      style={{
        ...
        <Section>
          <Row>
            <Column style={{ width: "64px" }}>
              <Img
                src={`https://react-email-demo-48zvx380u-resend.vercel.app/static/apple-hbo-max-icon.jpeg`}
                width="64"
                height="64"
                alt="HBO Max"
                style={productIcon}
        ...
        <Section>
          <Row>
            <Column align="center" style={ctaTitle}>
              <Text style={ctaText}>Save 3% on all your Novu purchases.</Text>
            </Column>
          </Row>
        </Section>
        <Section>
          <Row>
            <Column align="center" style={walletWrapper}>
              ...
              >
                <Img
                  src={`https://react-email-demo-48zvx380u-resend.vercel.app/static/apple-wallet.png`}
                  width="28"
                  height="28"
                  alt="Novu Wallet"
                  style={walletImage}
        ...
        <Text style={footerText}>
          1. 3% savings is earned as Daily Cash and is transferred to your Novu
          Cash card when transactions post to your Novu Card account. If you do
          not have an Novu Cash card, Daily Cash can be applied by you as a
          credit on your statement balance. 3% is the total amount of Daily Cash
          earned for these purchases. See the Novu Card Customer Agreement for
          more details on Daily Cash and qualifying transactions.
        </Text>
        <Text style={footerText}>2. Subject to credit approval.</Text>
        <Text style={footerText}>
          To access and use all the features of Novu Card, you must add Novu
        ...
        <Text style={footerText}>
          Novu Card is issued by Goldman Sachs Bank USA, Salt Lake City Branch.
        </Text>
        <Text style={footerText}>
          If you reside in the US territories, please call Goldman Sachs at
          877-255-5923 with questions about Novu Card.
        </Text>

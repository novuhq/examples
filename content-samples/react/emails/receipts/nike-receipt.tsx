      ...
      <Container style={container}>
        ...
        <Section style={message}>
          ...
          <Text style={{ ...global.text, marginTop: 24 }}>
            ...
            please visit your Orders page on Novu.com or in the Novu app.
          </Text>
        </Section>
        <Hr style={global.hr} />
        ...
        >
          <Row>
            <Column>
              <Img
                src={`https://react-email-demo-48zvx380u-resend.vercel.app/static/nike-product.png`}
            ...
            <Column style={{ verticalAlign: "top", paddingLeft: "12px" }}>
              <Text style={{ ...paragraph, fontWeight: "500" }}>
                Brazil 2022/23 Stadium Away Women's Novu Dri-FIT Soccer Jersey
              </Text>
        ...
        <Section style={paddingY}>
          ...
          <Row style={recomendations.container}>
            ...
            >
              <Img
                src={`https://react-email-demo-48zvx380u-resend.vercel.app/static/nike-recomendation-1.png`}
                alt="Brazil 2022/23 Stadium Away Women's Novu Dri-FIT Soccer Jersey"
                width="100%"
              />
              ...
              <Text style={recomendations.text}>
                Women's Novu Dri-FIT Soccer Jersey
              </Text>
            </Column>
            <Column style={recomendations.product} align="center">
              <Img
                src={`https://react-email-demo-48zvx380u-resend.vercel.app/static/nike-recomendation-2.png`}
                alt="Brazil 2022/23 Stadium Away Women's Novu Dri-FIT Soccer Jersey"
                width="100%"
              />
              <Text style={recomendations.title}>
              ...
              <Text style={recomendations.text}>
                Men's Novu Dri-FIT Short-Sleeve Football Shirt
              </Text>
            </Column>
            <Column style={recomendations.product} align="center">
              <Img
                src={`https://react-email-demo-48zvx380u-resend.vercel.app/static/nike-recomendation-3.png`}
                alt="Brazil 2022/23 Stadium Away Women's Novu Dri-FIT Soccer Jersey"
                width="100%"
              />
            ...
            >
              <Img
                src={`https://react-email-demo-48zvx380u-resend.vercel.app/static/nike-recomendation-4.png`}
                alt="Brazil 2022/23 Stadium Away Women's Novu Dri-FIT Soccer Jersey"
                width="100%"
              />
              <Text style={recomendations.title}>FFF</Text>
              <Text style={recomendations.text}>
                Women's Novu Pre-Match Football Top
              </Text>
            </Column>
          </Row>
        </Section>
            ...
            <Column>
              <Row>
                <Column style={{ width: "16px" }}>
                  <Img
                    src={`https://react-email-demo-48zvx380u-resend.vercel.app/static/nike-phone.png`}
                    width="16px"
                    height="26px"
        ...
        <Section style={paddingY}>
          <Row>
            <Text style={global.heading}>Novu.co</Text>
          </Row>
        ...
        <Section style={paddingY}>
          ...
          <Row>
            <Text style={footer.text}>
              © 2022 Novu, Inc. All Rights Reserved.
            </Text>
          </Row>
          <Row>
            <Text style={footer.text}>
              Novu, INC. One Bowerman Drive, Beaverton, Oregon 97005, USA.
            </Text>
          </Row>
        </Section>
      </Container>
...
export default NovuReceiptEmail;

...
export const zodControlSchema = z.object({
  ...
  bodyText: z.string().default("was a great guest! Easy communication, the apartment was left in great condition, very polite, and respectful of all house rules. He’s welcome back anytime and would easily recommend him to any host!"),
  questionOne: z.string().default("How do reviews work?"),
  linkToAnswerOne: z.string().url().default("https://airbnb.com/help/article/13"),
  questionTwo: z.string().default("How do reviews work?"),
  linkToAnswerTwo: z.string().url().default("https://airbnb.com/help/article/14"),

import {
  ...
  interface NovuAccessTokenEmailProps {
    username?: string;
  }
  ...
  export const NovuAccessTokenEmail = ({
    username,
  }: NovuAccessTokenEmailProps) => (
    <Html>
      <Head />
      <Preview>
  ...
  NovuAccessTokenEmail.PreviewProps = {
    username: "alanturing",
  } as NovuAccessTokenEmailProps;
  
  export default NovuAccessTokenEmail;

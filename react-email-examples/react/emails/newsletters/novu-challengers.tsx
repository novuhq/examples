...
export const NovuChallengersEmail = () => (
  <Html>
    <Head />
    <Preview>#Novu: Cubes</Preview>
    <Body style={main}>
      ...
      <Container style={container}>
        <Text style={challengeLink}>
          <Link style={link}>View this Challenge on Novu</Link>
        </Text>

        <Heading style={heading}>
          <strong>This week:</strong> Novu:{" "}
        ...
        <Section style={section}>
          ...
          <Text style={text}>
            ...
            <Link style={blueLink}>Novu: Round</Link> collection.
          </Text>
          ...
          <Section style={sectionPro}>
            ...
            <Text>
              Novu PRO combines a bunch of features that can help any
        ...
        <Text style={yellowSection}>
          ...
          <Link style={blueLink}>Instagram</Link> (Use the Novu tag
            ...
            <Column style={ideas}>
              ...
              <Section style={yellowCard}>
                ...
                <Text style={textCard}>
                  ...
                  scope of a Novu challenge, but you could use front-end
...
export default NovuChallengersEmail;
